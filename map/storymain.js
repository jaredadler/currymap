...
instaControl.update = function (props) {
  ...
  if (instaloc.length === 0) {
    $('#instafeed').empty();
    noInstaMessage = "No instagram photos yet. <a target='_blank' href='" + props.site_link + "dtlphotolst/1/'>(Check photos on Tabelog)</a>";
  }
...
$.getJSON('map/clayers/tokyocurry_c1.geojson', function(data) {
...
$.getJSON('map/clayers/tokyocurry_c2.geojson', function(data) {
...
$.getJSON('map/clayers/tokyocurry_c3.geojson', function(data) {
...
$.getJSON('map/clayers/tokyocurry_c4.geojson', function(data) {
...
$.getJSON('map/clayers/tokyocurry_c5.geojson', function(data) {
...
$.getJSON('map/clayers/tokyocurry_c6.geojson', function(data) {
...
$.getJSON('map/clayers/tokyocurry_c7.geojson', function(data) {
...
$.getJSON('map/clayers/tokyocurry_c8.geojson', function(data) {
...
$.getJSON('map/clayers/tokyocurry_c9.geojson', function(data) {
...
$('#c1').change(function() {
  if(this.checked) {
    var gjfile = 'map/clayers/' + this.value + '.geojson';
...
$('#highlight_none').change(function() {
  ...
  if(this.checked) {
    ...
    if(document.getElementById('c10').checked) {
      map.removeLayer(geojson_c10);
      $.getJSON('map/clayers/tokyocurry_c10.geojson', function(data) {
...
inputBox.onkeyup = function(){
  if (inputBox.value) {
    ...
    console.log('click');
     map.panTo([resultSet[0]['lat'], resultSet[0]['lng']]);
    });
    $('#result2').on('click', function (){
    console.log('click');
     map.panTo([resultSet[1]['lat'], resultSet[1]['lng']]);
    });
    $('#result3').on('click', function (){
    console.log('click');
     map.panTo([resultSet[2]['lat'], resultSet[2]['lng']]);
    });
    $('#result4').on('click', function (){
    console.log('click');
     map.panTo([resultSet[3]['lat'], resultSet[3]['lng']]);
    });
    $('#result5').on('click', function (){
    console.log('click');
     map.panTo([resultSet[4]['lat'], resultSet[4]['lng']]);
    });
  }
  else {
    document.getElementById('locateinputtext').innerHTML = "";
